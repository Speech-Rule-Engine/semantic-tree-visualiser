...
streeVis.prototype.update = function(source) {
  ...
  var nodeEnter =
      ...
      .attr('transform', function(d) {
          return 'translate(' + this.orientX(d, true) + ',' +
            this.orientY(d, true) + ')'; }.bind(this))
        .on('click', function(d) {
  ...
  nodeEnter.append('svg:title')
    .text(function(d) { return d.data.type + ': ' + d.data.role; });
  ...
  var link = this.vis.selectAll('path.link')
      .data(root.links(nodes), function(d) { return d.target.id; });
